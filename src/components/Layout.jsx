            ...
            <header
                ...
                <div className="flex justify-between items-center container w-[90%] mx-auto">
                    ...
                    <div className=" flex gap-5 items-center">
                        <a href="public\CV 2023.pdf" download="CV Alexis Muñoz - Front-End Developer" className=" border border-black/80 p-2 rounded-md font-bold text-sm text-black/80 hover:bg-gray-100 transition-colors"
                        >Descargar CV</a>
